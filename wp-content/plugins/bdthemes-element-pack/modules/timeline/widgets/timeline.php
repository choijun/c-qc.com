...
class Timeline extends Widget_Base {
	...
	public function render() {
		...
		$icon_parallax = ('yes' === $settings['item_animation']) ? ' bdt-parallax="scale: 0.5,1;viewport: 0.5;"' : '';
				...
				<div class="bdt-grid bdt-grid-collapse">
					...
					while ( $wp_query->have_posts() ) : $wp_query->the_post();
						...
						if ('center' == $align) {
							...
							$item_parallax      = ('yes' == $settings['item_animation']) ? ' bdt-parallax="opacity:0,1;x:'.$parallax_direction.'200,0;viewport: 0.5;"' : '';
						} elseif ('right' == $align) {
							$item_parallax      = ('yes' == $settings['item_animation']) ? ' bdt-parallax="opacity: 0,1;x: -200,0;viewport: 0.5;"' : '';
						...
						if( $bdt_count%2 === 0 and 'center' == $align ) : ?>
							<?php $date_parallax = ('yes' == $settings['item_animation']) ? ' bdt-parallax="opacity: 0,1;x: -200,0;viewport: 0.5;"' : '';?>
				  			<div class="bdt-timeline-item bdt-width-1-2@m bdt-visible@m">
						  		<div class="bdt-timeline-date bdt-text-right"<?php echo $date_parallax; ?>><span><?php echo esc_attr(get_the_date('d F Y')); ?></span></div>
							</div>
						<?php endif; ?>
			  			...
			  			<div class="<?php echo ('center' == $align) ? ' bdt-width-1-2@m ' : ' '; ?>bdt-timeline-item <?php echo $item_part . '-part'; ?>">
				  			...
				  			<div class="bdt-timeline-item-main-wrapper">
				  				<div class="bdt-timeline-line"><span bdt-parallax="opacity: 0,1;viewport: 0.5;"></span></div>
					  			<div class="bdt-timeline-item-main-container">
						  			...
						  			<div class="bdt-timeline-item-main"<?php echo $item_parallax; ?>>
						  				...
						  				<?php if ( $settings['show_image'] and isset($post_thumbnail[0])) : ?>
					  	...
					  	<?php if( $bdt_count%2 === 1 and ('center' == $align) ) : ?>
					  		<?php $date_parallax = ('yes' == $settings['item_animation']) ? ' bdt-parallax="opacity: 0,1;x: 200,0;viewport: 0.5;"' : '';?>
				  			<div class="bdt-timeline-item bdt-width-1-2@m bdt-visible@m">
						  		<div class="bdt-timeline-date"<?php echo $date_parallax; ?>><span><?php echo esc_attr(get_the_date('d F Y')); ?></span></div>
							</div>
						<?php endif; ?>
