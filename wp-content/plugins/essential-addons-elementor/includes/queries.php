...
if ( !function_exists('eael_get_filtered_templates') ) {
    function eael_get_filtered_templates( $type = '' ) {
        $args = [
            'post_type'         => 'elementor_library',
            'posts_per_page'    => -1,
        ];
...
function get_page_template_options( $type = '' ) {

    $page_templates = eael_get_filtered_templates( $type );
