...
function eael_get_block_pass_protected_form( $settings ) {
    echo '<div class="eael-password-protected-content-fields">';
    echo '<form method="post">';
    echo '<input type="password" name="protection_password" class="eael-password" placeholder="Enter Password">';
    echo '<input type="submit" value="Submit" class="eael-submit">';
    echo '</form>';
