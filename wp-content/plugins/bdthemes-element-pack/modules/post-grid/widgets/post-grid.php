	...
	protected function _register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'condition' => [
					'_skin!' => ['bdt-carmie', 'bdt-trosia', 'bdt-reverse'],
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'default'   => 'full',
				'condition' => [
					'_skin' => ['', 'bdt-harold', 'bdt-elanza', 'bdt-modern'],
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options'      => [
					...
					//'masonry'      => esc_html__('Masonry', 'bdthemes-element-pack'),
				],
				'condition' => [
					'_skin' => 'bdt-harold'
				]
