		  	...
		  	<form action="" method="POST" id="eael-settings" name="eael-settings">
		  		<div class="eael-header-bar">
					...
					<div class="eael-header-right">
						<button type="submit" class="button eael-btn js-eael-settings-save"><?php _e('Сохранить настройки', 'essential-addons-elementor'); ?></button>
					</div>
				</div>
			  	<div class="response-wrap"></div>
			  	<div class="eael-settings-tabs">
			    	<ul class="eael-tabs">
				      	<li><a href="#general" class="active"><img src="<?php echo plugins_url( '/', __FILE__ ).'assets/images/icon-settings.svg'; ?>"><span>Общее</span></a></li>
				      	<li><a href="#elements"><img src="<?php echo plugins_url( '/', __FILE__ ).'assets/images/icon-modules.svg'; ?>"><span>элементы</span></a></li>
			    	</ul>
				      			...
				      			<div class="eael-admin-block-wrapper">
				      				<div class="eael-admin-block eael-admin-block-license">
										<header class="eael-admin-block-header">
											...
											<h4 class="eael-admin-title">Автоматическое обновление</h4>
										</header>
									...
									<div class="eael-admin-block eael-admin-block-support">
										<header class="eael-admin-block-header">
											...
											<h4 class="eael-admin-title">Нужна помощь?</h4>
										</header>
										<div class="eael-admin-block-content">
											<p>Застрял с чем-то? Получите помощь из чата или поддержки.</p>
									...
									<div class="eael-admin-block eael-admin-block-community">
										...
										<div class="eael-admin-block-content">
											<p>Присоединяйтесь к сообществу Facebook и обсуждайте с другими разработчиками и пользователями. Лучший способ общаться с людьми и получать отзывы о ваших проектах.</p>

											<a href="https://www.facebook.com/groups/essentialaddons" class="review-flexia button button-primary" target="_blank">Присоединяйтесь к сообществу Facebook</a>
										</div>
									</div>
				      	...
				      	<div class="row">
				      		<div class="col-full">
								...
								<div class="eael-checkbox-container">
									...
									<div class="eael-checkbox">
										<input type="checkbox" id="offcanvas" name="offcanvas" <?php checked( 1, $this->eael_get_settings['offcanvas'], true ); ?> >
										<label for="offcanvas"></label>
										<p class="eael-el-title"><?php _e( 'Offcanvas', 'essential-addons-elementor' ) ?></p>
									</div>
								</div>
				      			<!-- Content Element Ends -->
				      			<!-- Dynamic Content Element Starts -->
				      			<h4>Элементы динамического содержимого</h4>
								<div class="eael-checkbox-container">
									<div class="eael-checkbox">
								...
								<div class="eael-checkbox-container">
									<div class="eael-checkbox">
										...
										<p class="eael-el-title"><?php _e( 'Mailchimp', 'essential-addons-elementor' ) ?>
											(<span><a href="#" id="eael-popup-mailchimp-api-modal">настройки</a></span>)
				      			...
				      			<h4>Элементы социальных каналов</h4>
								<div class="eael-checkbox-container">
									<div class="eael-checkbox">
