			...
			<div class="parallax-wrapper">
            	<div class="vc_col-sm-12 wpb_column vc_column_container">
                	<div class="wpb_wrapper">
                        ...
                        <h3 class="page-title"><?php _e('Recent Posts by ', 'logistic'); echo $curauth->display_name; ?></h3>
						...
						<?php
							...
							?>
                            <div class="post-meta">
                                <p class="g"><?php _e('By ', 'logistic'); ?></p>
                                <p><?php the_author_posts_link(); ?></p>
                                <p class="g"><?php _e(' in ', 'logistic');?></p>
                                <p><?php the_category(', '); ?></p>
                                <p class="g"><?php _e('Posted ', 'logistic'); ?></p>
                                <p><?php the_time('F j, Y'); _e(' at ', 'logistic'); the_time(); ?></p>
                            </div><!--#post-meta-->                  
                            <?php
                        ...
                        <div class="no-results">
                            <p><strong><?php _e('There has been an error.', 'logistic'); ?></strong></p>
                            <p><?php _e('We apologize for any inconvenience, please hit back on your browser or use the search form below.', 'logistic'); ?></p>
                        ...
                        <div id="recent-author-comments">
                            <h3 class="page-title"><?php _e('Recent Comments by ', 'logistic'); echo $curauth->display_name; ?></h3>
                            <?php
                            ...
                            <ul>
                                <?php
                                    ...
                                    echo  '<li class="recentcomments"><i class="oic-bubble"></i>&nbsp;' . sprintf(__('%1$s on %2$s', 'logistic'), get_comment_date(), '<a href="'. get_comment_link($comment->comment_ID) . '">' . get_the_title($comment->comment_post_ID) . '</a>') . '</li>';
                                endforeach; else: ?>
                                    <p><?php _e('No comments by ', 'logistic'); echo $curauth->display_name; ?></p>
                                <?php endif; ?>
                            </ul>
