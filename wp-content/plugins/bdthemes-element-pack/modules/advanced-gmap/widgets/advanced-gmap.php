...
class Advanced_Gmap extends Widget_Base {
	...
	public function get_icon() {
		return 'bdt-widget-icon eicon-google-maps';
	}
	...
	protected function render() {
		...
		$this->add_render_attribute( 'advanced-gmap', 'data-map_markers', json_encode($all_markers) );
		...
		$this->add_render_attribute( 'advanced-gmap', 'data-map_settings', json_encode($map_settings) );
