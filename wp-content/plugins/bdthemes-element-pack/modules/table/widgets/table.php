...
class Table extends Widget_Base {
	...
	protected function render() {
		...
		$stripe_style = $settings['stripe_style'] ? ' bdt-stripe' : '';

		?>
		<div id="<?php echo esc_attr($id); ?>" class="bdt-table<?php echo esc_attr( $stripe_style ); ?>">
		...
		<?php if ( 'yes' == $settings['show_pagination'] or 'yes' == $settings['show_info'] or 'yes' == $settings['show_searching'] or 'yes' == $settings['show_ordering']) : ?>
		<script>
