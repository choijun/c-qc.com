<?php
	...
	class Darx_Likes extends Darx_Parent {
		...
		{
			add_submenu_page('darx-modules', __('Likes Settings — Social API', 'vkapi'), __('Likes Settings', 'vkapi'), 'manage_options', 'darx-likes-settings', array(
				$this,
				'page_likes_settings'
			));
		}
		...
		public function register_settings()
		{
			...
			add_settings_field('vkapi_like_top', // id
			...
			add_settings_field('vkapi_like_bottom', // id
			...
			add_settings_section('darx-gp-like', // id
				__('Like button', 'vkapi'), // title
				'__return_null', // callback
			...
			add_settings_field('gpapi_show_like', // id
				__('Enable', 'vkapi'), // title
				array($this, 'render_settings_field'), // callback
				'darx-likes-settings-gp', // page
			...
			add_settings_field('gpapi_like_cat', // id
				__('Show in Categories page and Home', 'vkapi'), // title
				array($this, 'render_settings_field'), // callback
				'darx-likes-settings-gp', // page
				'darx-gp-like', // section
