					...
					<?php endif; ?>
	  				...
	  				<div class="<?php echo ('center' == $align) ? ' bdt-width-1-2@m ' : ' '; ?>bdt-timeline-item <?php echo $item_part . '-part'; ?>">
			  			...
			  			<div class="bdt-timeline-item-main-wrapper">
				  			...
				  			<div class="bdt-timeline-item-main-container">
					  			...
					  			<?php $item_scrollspy = ($settings['item_animation']) ? ' bdt-scrollspy="cls: bdt-animation-slide-'.$item_part.'-medium;"' : ''; ?>
					  			<div class="bdt-timeline-item-main"<?php echo $item_scrollspy; ?>>
							  		...
							  		<div class="bdt-timeline-desc bdt-padding">
										...
										<?php if ($settings['show_meta']) : ?>
											<ul class="bdt-timeline-meta bdt-subnav bdt-flex-middle<?php echo esc_attr($hidden_class); ?>"><li><?php echo esc_attr($item['timeline_date']); ?></li></ul>
										<?php endif ?>
										...
										<?php if ($settings['show_readmore']) :
											...
											$this->parent->add_render_attribute(
													[
														'timeline-readmore' => [
															'href'  => esc_url($item['timeline_link']),
															'class' => [
											...
											?>
											<a <?php echo $this->parent->get_render_attribute_string( 'timeline-readmore' ); ?>>
				  	...
				  	<?php if( $bdt_count%2 === 1 and ('center' == $align) ) : ?>
				  		<?php 
				  			...
				  			$item_scrollspy = ($settings['item_animation']) ? ' bdt-scrollspy="cls: bdt-animation-slide-'.$item_part.'-medium;"' : ''; ?>
			  			<div class="bdt-timeline-item bdt-width-1-2@m bdt-visible@m">
