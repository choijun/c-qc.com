...
class Image_Magnifier extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Image Magnifier Gallery', 'bdthemes-element-pack' ),
	...
	public function render() {
		...
		$this->add_render_attribute(
			[
				'image-magnifier-settings' => [
					...
					'data-image_magnifier' => '',
					'data-type'            => $settings['type'],
					'data-smooth_move'     => $settings['smooth_move'] ? 'true' : 'false',
					'data-preload'         => $settings['preload'] ? 'true' : 'false',
					'data-zoom_size'       => '[' . $zoom_ratio . ']',
					'data-offset'          => '[' . $offset . ']',
        ...
        if (isset($image_url[0])) {
        	?>
            <div class="bdt-image-magnifier bdt-position-relative">
                <img <?php echo $this->get_render_attribute_string( 'image-magnifier-settings' ); ?>>
            </div>
            <?php
        } else {
        	?>
