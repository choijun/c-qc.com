...
class WC_Carousel extends Widget_Base {
	...
	protected function render_navigation() {
		...
		<?php if ( 'arrows' == $settings['navigation'] ) : ?>
				<div class="bdt-position-z-index<?php echo esc_attr( $hide_arrows ); ?> bdt-position-<?php echo esc_attr($settings['arrows_position']); ?>">
		...
		<script>
			jQuery(document).ready(function($) {
			    ...
			    <?php if ($settings['pauseonhover']) : ?>
				    $("#<?php echo esc_attr($id); ?> .swiper-container").hover(function() {
