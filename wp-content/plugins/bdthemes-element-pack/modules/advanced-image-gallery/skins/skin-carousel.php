...
class Skin_Carousel extends Elementor_Skin_Base {
	...
	public function render_header($settings, $id, $skin) {

		$this->parent->add_render_attribute('advanced-image-gallery', 'id', 'bdt-avdg-' . esc_attr($id) );

		$this->parent->add_render_attribute('advanced-image-gallery', 'class', ['bdt-advanced-image-gallery', 'bdt-skin-' . esc_attr($skin)] );
	...
	public function render() {
		...
		$this->render_header($settings, $id, $skin = 'carousel');
