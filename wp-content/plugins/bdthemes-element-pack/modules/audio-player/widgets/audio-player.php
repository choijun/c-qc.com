...
class Audio_Player extends Widget_Base {
	...
	public function render_loop() {
		...
		if ('hosted_url' == $settings['source_type']) {
			$this->add_render_attribute( 'audio-player', 'data-audio_source', $settings['hosted_url']['url'] );
		} elseif ('remote_url' == $settings['source_type']) {
			$this->add_render_attribute( 'audio-player', 'data-audio_source', $settings['remote_url']['url'] );
		}

		$this->add_render_attribute( 'audio-player', 'data-audio_title', $settings['title'] );
		$this->add_render_attribute( 'audio-player', 'data-volume_level', $settings['volume_level']['size'] );
		$this->add_render_attribute( 'audio-player', 'data-keyboard_enable', ('yes' == $settings['keyboard_enable']) ? 'true' : 'false' );
		$this->add_render_attribute( 'audio-player', 'data-smooth_show', ('yes' == $settings['smooth_show']) ? 'true' : 'false' );
		$this->add_render_attribute( 'audio-player', 'data-time_restrict', ('yes' == $settings['time_restrict']) ? 'true' : 'false' );
		$this->add_render_attribute( 'audio-player', 'data-restrict_duration', $settings['restrict_duration']['size'] );
		$this->add_render_attribute( 'audio-player', 'data-autoplay', ('yes' == $settings['autoplay']) ? 'true' : 'false' );
