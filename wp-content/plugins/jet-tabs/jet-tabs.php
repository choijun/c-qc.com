 ...
 * Description: JetTabs - вкладки и аккордеоны для Elementor Page Builder
 * Version:     1.1.4
 * Author:      Zemez
			...
			$config = array(
				...
				'strings'      => array(
					'notice_can_install_required'     => _n_noop(
						'JetTabs для Elementor требует следующий плагин: %1$s.',
						'JetTabs для Elementor требует следующих плагинов: %1$s.',
						'jet-tabs'
					),
					'notice_can_install_recommended'  => _n_noop(
						'JetTabs для Elementor рекомендует следующий плагин: %1$s.',
						'JetTabs для Elementor рекомендует следующие плагины: %1$s.',
						'jet-tabs'
					),
				),
			);
