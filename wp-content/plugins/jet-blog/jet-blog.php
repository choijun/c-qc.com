 ...
 * Description: Пакет блогов для Elementor Page Builder
 * Version:     2.1.8
 * Author:      Zemez
			...
			$config = array(
				...
				'strings'      => array(
					'notice_can_install_required'     => _n_noop(
						'Jet Blog для Elementor требует следующий плагин: %1$s.',
						'Jet Blog для Elementor требует следующих плагинов: %1$s.',
						'jet-blog'
					),
					'notice_can_install_recommended'  => _n_noop(
						'Jet Blog для Elementor рекомендует следующий плагин: %1$s.',
						'Jet Blog для Elementor рекомендует следующие плагины: %1$s.',
						'jet-blog'
					),
				),
			);
