	...
	protected function render() {
		...
		if ($settings['animated_heading'] and 'animated' == $settings['heading_layout']) {
			$heading_animation_duration = ($settings['heading_animation_duration']) ? ' bdt-animated-'.$settings['heading_animation_duration'] : '';
	   		$final_heading .= '<div id="bdt-ah-'.$id.'" class="bdt-animated-heading'.$heading_animation_duration.'" ' . $this->get_render_attribute_string( 'animated-heading' ) . '>'.rtrim(esc_attr($settings['animated_heading']), ',') . '</div> ';
		} elseif ($settings['animated_heading'] and 'typed' == $settings['heading_layout']) {
			$final_heading .= '<div id="bdt-ah-'.$id.'" class="bdt-animated-heading" ' . $this->get_render_attribute_string( 'animated-heading' ) . '></div> ';
		}
