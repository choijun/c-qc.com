...
class OZY_Filedownload_Widget extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array( 'classname' => 'filedownload', 'description' => __('This widget will help you to display download links with icons.', 'logistic') );		
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'filedownload-widget' );		
		parent::__construct( 'filedownload-widget', __('(Logistic) File Download Box', 'logistic'), $widget_ops, $control_ops );
	}
	...
	function icon_list($initial_key = '') {
		$icons = array(
			'gen' => __('Generic', 'logistic'),
			'mp3' => __('Audio', 'logistic'),
			'mov' => __('Movie', 'logistic'),
			'doc' => __('Word', 'logistic'),
			'pdf' => __('Acrobat', 'logistic'),
			'xls' => __('Excel', 'logistic'),
			'zip' => __('Compressed', 'logistic'),
			'mdb' => __('Access', 'logistic')
		);
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><?php _e('Title:', 'logistic'); ?></label>
			<input id="<?php echo esc_attr($this->get_field_id( 'title' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'title' )); ?>" value="<?php echo esc_attr($instance['title']); ?>" style="width:100%;" />
		</p>
        
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'icon1' )); ?>"><?php _e('File #1:', 'logistic'); ?></label>
            ...
            <label for="<?php echo esc_attr($this->get_field_id( 'title1' )); ?>"><?php _e('Caption:', 'logistic'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'icon2' )); ?>"><?php _e('File #2:', 'logistic'); ?></label>
            ...
            <input type="button" value="..." class="upload-image-button"/>
            <label for="<?php echo esc_attr($this->get_field_id( 'title2' )); ?>"><?php _e('Caption:', 'logistic'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'icon3' )); ?>"><?php _e('File #3:', 'logistic'); ?></label>
            ...
            <input type="button" value="..." class="upload-image-button"/>
            <label for="<?php echo esc_attr($this->get_field_id( 'title3' )); ?>"><?php _e('Caption:', 'logistic'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'icon4' )); ?>"><?php _e('File #4:', 'logistic'); ?></label>
            ...
            <input type="button" value="..." class="upload-image-button"/>
            <label for="<?php echo esc_attr($this->get_field_id( 'title4' )); ?>"><?php _e('Caption:', 'logistic'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'icon5' )); ?>"><?php _e('File #5:', 'logistic'); ?></label>
            ...
            <input type="button" value="..." class="upload-image-button"/>
            <label for="<?php echo esc_attr($this->get_field_id( 'title5' )); ?>"><?php _e('Caption:', 'logistic'); ?></label>
...
class OZY_Testimonial_Widget extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array( 'classname' => 'testimonial', 'description' => __('This widget will help you to display a testimonial box.', 'logistic') );		
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'testimonial-widget' );		
		parent::__construct( 'testimonial-widget', __('(Logistic) Testimonial Box', 'logistic'), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'content' )); ?>"><?php _e('Content:', 'logistic'); ?></label>
...
class OZY_CustomMenu_Widget extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array( 'classname' => 'custommenu', 'description' => __('This widget will display custom menu from selected menu.', 'logistic') );
		
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'custommenu-widget' );
		
		parent::__construct( 'custommenu-widget', __('(Logistic) Custom Menu', 'logistic'), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		//Set up some default widget settings.
		$defaults = array( 'title' => __('Custom Menu', 'logistic'), 'active_menu' => '' );
		$instance = wp_parse_args( (array) $instance, $defaults ); ?>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'active_menu' )); ?>"><?php _e('Menu:', 'logistic'); ?></label>
			<?php
...
class OZY_LatestPosts_Widget extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array( 'classname' => 'latestposts', 'description' => __('This widget will display latest posts in multiple view modes.', 'logistic') );
		
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'latestposts-widget' );
		
		parent::__construct( 'latestposts-widget', __('(Logistic) Latest Posts', 'logistic'), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		//Set up some default widget settings.
		$defaults = array( 'title' => __('Latest Posts', 'logistic'), 'type' => 'list_with_thumbs', 'post_type' => 'post', 'order' => 'ASC', 'orderby' => 'title', 'post_per_page' => 6 );
		$instance = wp_parse_args( (array) $instance, $defaults ); ?>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'type' )); ?>"><?php _e('Type:', 'logistic'); ?></label>
			<?php
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'post_type' )); ?>"><?php _e('Post Type:', 'logistic'); ?></label>
			<?php
				$args = array(
				   'public'   => true,
				   '_builtin' => false
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'order' )); ?>"><?php _e('Order:', 'logistic'); ?></label>
			<?php
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'orderby' )); ?>"><?php _e('Order By:', 'logistic'); ?></label>
			<?php
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'post_per_page' )); ?>"><?php _e('Count:', 'logistic'); ?></label>
...
class OZY_Flickr_Widget extends WP_Widget {
	function __construct() {
		parent::__construct('flickr_widget', '(Logistic) Flickr Widget', array('classname' => 'flickr', 'description' => __('(Logistic) Flickr Widget for user photo stream!', 'logistic')), array('id_base' => 'flickr_widget'));
	}
	...
	function widget($args, $instance)
	{
		...
		if($user_name && $number) {
			...
			if($user_name) {
				...
				echo '<p>'. __('Invalid flickr user ID.', 'logistic') .'</p>';
			}
		}
		if($under_text!=''){
