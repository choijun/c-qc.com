...
class Panel_Slider extends Widget_Base {
	...
	protected function render_header() {
		...
		?>
		<div class="bdt-panel-slider<?php echo esc_attr($skin_class); ?>">
			<div class="swiper-container">
		<?php
	}

	protected function render_footer($settings, $id) {
		...
		<script>
			jQuery(document).ready(function($) {
			    "use strict";				    
			    var swiper = new Swiper(".elementor-element-<?php echo esc_attr($id); ?> .swiper-container", {
					"pagination" : {
						el        : ".elementor-element-<?php echo esc_attr($id); ?> .swiper-pagination",
						type      : 'bullets',
						clickable : true,
					},
			        "paginationClickable" : true,
			        navigation: {
						nextEl: ".elementor-element-<?php echo esc_attr($id); ?> .swiper-button-next",
						prevEl: ".elementor-element-<?php echo esc_attr($id); ?> .swiper-button-prev",
					},
					"autoplay"       : <?php echo ('yes'   ==  $settings['autoplay']) ? '{ "delay": ' . $settings['autoplay_speed'] . ' }' : 'false'; ?>,
					"loop"           : <?php echo ('yes'   ==  $settings['infinite']) ? 'true' : 'false'; ?>,
					"speed"          : <?php echo esc_attr($settings['speed']); ?>,
					"slidesPerView"  : <?php echo esc_attr($columns); ?>,
					"spaceBetween"   : <?php echo ($settings['column_space']['size']) ? : '0' ?>,
					"centeredSlides" : <?php echo ('yes' == $settings['centered_slide'] or 'bdt-middle' == $settings['_skin']) ? 'true' : 'false'; ?>,
					"breakpoints"    : {
			            "<?php echo $viewport_lg; ?>" : {
			            	"slidesPerView": <?php echo esc_attr($columns_tablet); ?>,
			            },
			            "<?php echo $viewport_md; ?>" : {
			            	"slidesPerView": <?php echo esc_attr($columns_mobile); ?>,
			            }
			        }
			    });

			    <?php if ($settings['pauseonhover']) : ?>
				    $(".elementor-element-<?php echo esc_attr($id); ?> .swiper-container").hover(function() {
	...
	public function render() {
		...
		$this->render_footer($settings, $id);
	}
}
