...
function woocommerce_header_add_to_cart_fragment( $fragments ) {
	...
	ob_start();
	?>
    <a href="<?php echo esc_url(wc_get_cart_url()); ?>" class="cart-contents"><i class="oic-simple-line-icons-52"></i>&nbsp;&nbsp;<span><?php _e('SHOPPING BAG:&nbsp;&nbsp;', 'logistic');echo $woocommerce->cart->get_cart_total();?></span></a>
	<?php
