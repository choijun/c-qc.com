/*! bdtUIkit 3.0.0-rc.23 | http://www.getuikit.com | (c) 2014 - 2018 YOOtheme | MIT License */
    ...
    function Core (bdtUIkit) {
        ...
        ready(function () {
            ...
            on(window, 'scroll', function (e) {
                ...
                bdtUIkit.update(target.nodeType !== 1 ? document.body : target, e);
            }, {passive: true, capture: true});
            on(document, 'loadedmetadata load', function (ref) {
                var target = ref.target;

                return bdtUIkit.update(target, 'load');
            }, true);
    ...
    function install(bdtUIkit) {
        bdtUIkit.icon.add = function (name, svg) {
            ...
            if (bdtUIkit._initialized) {
                apply(document.body, function (el) { return each(bdtUIkit.getComponents(el), function (cmp) { return cmp.$options.isIcon && cmp.icon in added && cmp.$reset(); }
                    ); }
                );
            }
        };
