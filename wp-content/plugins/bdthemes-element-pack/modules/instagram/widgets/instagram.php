	...
	public function render() {
		...
		$this->add_render_attribute(
			[
				'instagram-settings' => [
					'id'                     => esc_attr( $id ),
					'data-container'         => esc_attr( $id ),
					'class'                  => [ 'bdt-instagram' ],
					'data-username'          => ($settings['username']) ? $settings['username'] : 'selimmw',
					'data-layout'            => esc_attr($settings['layout']),
					'data-show_profile'      => ($settings['show_profile'] and 'grid' === $settings['layout']) ? 'true' : 'false',
					'data-show_biography'    => ($settings['show_profile'] and 'grid' === $settings['layout']) ? 'true' : 'false',
					'data-show_lightbox'     => ($settings['show_lightbox']) ? 'true' : 'false',
					'data-items'     		 => esc_attr($settings['items']['size']),
					'data-columns'           => esc_attr($settings['columns']),
					'data-columns_tablet'    => esc_attr($settings['columns_tablet']),
					'data-columns_mobile'    => esc_attr($settings['columns_mobile']),
					'data-column_gap'        => esc_attr($settings['column_gap']),
					'data-comment_count'     => $settings['comment_count'] ? 'true' : 'false',
					'data-like_count'        => $settings['like_count'] ? 'true' : 'false',
					'data-loading_animation' => $settings['loading_animation'] ? 'true' : 'false',
				]
			]
		);

		?>
		<div <?php echo ( $this->get_render_attribute_string( 'instagram-settings' ) ); ?>></div>
