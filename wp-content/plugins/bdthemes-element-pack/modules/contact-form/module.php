...
class Module extends Element_Pack_Module_Base {
	...
	public function is_valid_captcha(){
		...
		if(isset($_POST['g-recaptcha-response']) and !empty($ep_api_settings['recaptcha_secret_key'])) {
			$request  = wp_remote_get( 'https://www.google.com/recaptcha/api/siteverify?secret='.$ep_api_settings['recaptcha_secret_key'].'&response='.$_POST["g-recaptcha-response"].'&remoteip='.$_SERVER["REMOTE_ADDR"] );
